...
pub fn LoginScreen(props: LoginScreenProps) -> Element {
    ...
    rsx! {
        div {
            style: "position: fixed; inset: 0; z-index: 90; display: flex; align-items: center; justify-content: center; background-color: #000; overflow: hidden; {bg_style}",
            ...
            div {
                ...
                div {
                    style: "font-size: 4.5rem; line-height: 1; font-weight: 300; margin-bottom: 0.5rem; font-family: 'Inter', 'Segoe UI', sans-serif;",
                    "{time_str}"
                }
                div {
                    style: "font-size: 1.25rem; font-weight: 500; opacity: 0.8; font-family: 'Inter', 'Segoe UI', sans-serif;",
                    "{date_str}"
                }
            }
            ...
            div {
                ...
                // Language
                div {
                    style: "height: 1.75rem; border: 1px solid rgba(255,255,255,0.25); border-radius: 4px; display: flex; align-items: center; justify-content: center; cursor: default; opacity: 0.7; padding: 0 0.5rem; font-size: 11px; color: white; font-weight: 500;",
                    "EN"
                }
            }
        }
